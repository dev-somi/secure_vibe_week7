    ...
    <main className="min-h-screen bg-[#FAFAFA] flex flex-col items-center justify-center p-4 md:p-8 text-[#1A1A1A]">
      ...
      <div className="max-w-4xl w-full flex flex-col items-center py-10">
        ...
        <div className="flex flex-col md:flex-row w-full items-stretch justify-center gap-10 md:gap-16 relative mb-12">
          ...
          {/* 왼쪽: 파일 업로드 영역 */}
          <div 
            className={`flex-1 border-[1.5px] border-dashed border-gray-600 rounded-lg p-10 flex flex-col items-center justify-center transition-all bg-transparent relative ${
              isDragging ? 'bg-white border-gray-900 shadow-md scale-[1.02]' : ''
            }`}
          ...
          >
            ...
            <button 
              ...
              className="bg-transparent border-[2.5px] border-gray-900 rounded-full px-8 py-2.5 font-bold text-gray-900 hover:bg-gray-100 transition-all hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-y-0.5 active:shadow-none"
            >
              파일 탐색
            </button>
